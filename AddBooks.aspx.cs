...
namespace OnlineBookStore
{
    public partial class AddBooks : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into books(BookID,Title,Author,Pages,Price,Category,Quantity,Version,Date,image,ownerID) values('" + txtTitle.Text + "','" + Label2.Text + "','" + txtPages.Text + "','" + txtPrice.Text + "','" + txtCategory.Text + "','" + txtQty.Text + "','" + txtVersion.Text + "','" + DateTime.Now + "','" + link + "','" + Label2.Text + "')";
