...
namespace OnlineBookStore
{
    public partial class addtocart2 : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    if (Session["Buyitems"] == null)
                    {
                        ...
                        String myquery = "select * from books where bookid=" + Request.QueryString["id"];
                        ...
                        dr["sno"] = 1;
                        dr["itemid"] = dt1.Rows[0]["bookid"].ToString();
                        dr["title"] = dt1.Rows[0]["title"].ToString();
                        dr["unitPrice"] = dt1.Rows[0]["Price"].ToString();
                        dr["quantity"] = Request.QueryString["quantity"];
                        dr["image"] = dt1.Rows[0]["image"].ToString();


                        int price = Convert.ToInt16(dt1.Rows[0]["Price"].ToString());
                    ...
                    else
                    {
                        ...
                        dr["sno"] = sr + 1;
                        dr["itemid"] = dt2.Rows[0]["bookid"].ToString();
                        dr["title"] = dt2.Rows[0]["title"].ToString();
                        dr["unitPrice"] = dt2.Rows[0]["Price"].ToString();
                        dr["quantity"] = Request.QueryString["quantity"];
                        dr["image"] = dt2.Rows[0]["image"].ToString();


                        int price = Convert.ToInt16(dt2.Rows[0]["Price"].ToString());
        ...
        private void SaveOrder(string customerID, string itemid, string q, string total)
        {
            ...
            string query = "insert into Customer_Orders(orderid,BookId,quantity,total,date,status,CustomerId,DeliveryDate,DeliveryTime,month,year) values('" + orderId + "','" + itemid + "','" + q + "','" + total + "','" + DateTime.Now + "','" + status + "','" + customerID + "','" + TextBox1.Text + "','" + TextBox2.Text + "','" + DateTime.Now.Month + "','" + DateTime.Now.Year + "')";
